...
public class XLog {
    ...
    public static boolean LOG = Ayo.debug;
    public static String TAG_ROOT = "ayo";
    ...
    public static void toFile(String tag, String msg, String filePath){
        ...
        Files.file.appendContent(filePath, "-------------" + tag + "------------\r\n" + msg);
    }
